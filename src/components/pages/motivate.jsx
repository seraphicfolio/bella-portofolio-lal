     ...
     <section className="w-full h-screen bg-[#f5d2d2] flex items-center justify-center px-[300px] py-10">
      <div className="mt-20 w-full h-full relative flex flex-col items-center justify-center">
        ...
        <div className="absolute -top-16 -right-20 blur-[2px]">
          <img data-aos-duration="1000" data-aos="fade-up-right" className="w-60 h-60" src="./flower.png" alt="flower" />
        </div>
        ...
        <div className="w-[60%] h-fit z-10 -ml-36 relative">
          <img data-aos-duration="1000" data-aos="fade-up-left" className="absolute -top-32 -left-32 w-72 h-72 blur-[2px]" src="./paus.png" alt="" />
          ...
          <div className="w-full h-[350px] bg-[#ffebd7] mt-10 shadow-xl shadow-red-300 flex items-center justify-center flex-col relative">
              ...
              <img data-aos-duration="1000" data-aos="fade-up-right" className="absolute h-72 w-7h-72 -bottom-28 -left-32 " src="./cloud.png" alt="cloud" />
              <img data-aos-duration="1000" data-aos="fade-up-right" className="absolute h-72 w-7h-72 -bottom-36 -left-3" src="./cloud.png" alt="cloud" />
