...
export default function Footer() {
  return (
    <>
      <section id="footer" className="w-full h-[450px] bg-[#F6F5F2] flex items-center justify-center px-[100px]">
            ...
            <div className="h-full w-1/2 flex flex-col items-center justify-between py-16">
                <div className="w-full h-full my-1 py-5 bg-[#ece3d5] flex items-center justify-between flex-col border-x-4 border-[#e8d9c1] relative">
                    ...
                    <div className="flex items-center justify-center flex-col gap-5">
                        ...
                        <a href="https://drive.usercontent.google.com/u/0/uc?id=1c7Bf3-d-DoL0dwB-NYtlE1oNQkF5nC2G&export=download" target="_blank" className="px-10 py-3 border-2 border-black duration-300 ease-in-out transition-all hover:border-[#e6d4b8] hover:bg-[#F0EBE3] hover:scale-110">Get in touch</a>
                    </div>
